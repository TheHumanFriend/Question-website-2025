...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Just some questions for funs 💚",
    ...
    questions: {
        first: {
         ...
         second: {
            ...
            nextBtn: "This much!",                                   // Text before the percentage
            noBtn: "Next 💚"
                                               // Text for "No" button
        },
         third: {
            text: "Really really? 🥺",                             // The big question!
        ...
        fourth: {
            ...
            noBtn: "No, not really.."                                           // Text for the next button
        },
    ...
    celebration: {
        ...
        message: "Now come get a huge kiss!",
    ...
    music: {
        ...
        musicUrl: "https://youtu.be/zgaCZOQCpp8", // Music streaming URL
